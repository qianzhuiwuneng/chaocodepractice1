        ...
        .sheet(isPresented: $shouldShowSheet) {
            ...
            AnyLayout.useVStack(if: shouldUseVStack, spacing: 30) {
                ...
                Grid(horizontalSpacing: 30, verticalSpacing: 12) {
                    buildNurtitionView(title:"热量", value: food.$calorie)
                    buildNurtitionView(title:"蛋白质", value: food.$protein)
                    buildNurtitionView(title:"脂肪", value: food.$fat)
                    buildNurtitionView(title:"碳水", value: food.$carb)
                }
            }
            .padding()
            .padding(.vertical)
...
private extension FoodListView {
    ...
    func buildNurtitionView(title: String, value: String) -> some View {
        GridRow {
